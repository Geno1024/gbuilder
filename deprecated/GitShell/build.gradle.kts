...
kotlin {
    linuxX64 {
        sourceSets.create("linuxX64Main")
        binaries {
            executable("gbuilder") {
                entryPoint = "com.geno1024.gbuilder.main"
                sourceSets.create("gbuilder")
            }
            executable("gbuilder-init") {
                entryPoint = "com.geno1024.gbuilder.init.main"
                sourceSets.maybeCreate("gbuilder-init")
            }
        }
    }
//    linuxX64 {
